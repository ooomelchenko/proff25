...
var app = {
    ...
    layoutSidebars: function () {
        $(window).width() < app.settings.screen_md ? ($(".app-container").hasClass("app-sidebar-left-minimized") && ($(".app-container").removeClass("app-sidebar-left-minimized"), $(".app-sidebar.dir-left").removeClass("app-navigation-minimized"), $(".app-sidebar.dir-left").attr("data-minimized", "minimized")), $(".app-container").hasClass("app-sidebar-right-minimized") && ($(".app-container").removeClass("app-sidebar-right-minimized"), $(".app-sidebar.dir-right").removeClass("app-navigation-minimized"), $(".app-sidebar.dir-right").attr("data-minimized", "minimized"))) : ("minimized" === $(".app-sidebar.dir-left").data("minimized") && ($(".app-container").addClass("app-sidebar-left-minimized"), $(".app-sidebar.dir-left").addClass("app-navigation-minimized"), $(".app-sidebar.dir-left").mCustomScrollbar("disable", !0)), "minimized" === $(".app-sidebar.dir-right").data("minimized") && ($(".app-container").addClass("app-sidebar-right-minimized"), $(".app-sidebar.dir-right").addClass("app-navigation-minimized"), $(".app-sidebar.dir-right").mCustomScrollbar("disable", !0)))
    },
    navigation: function () {
    ...
    spy: function () {
        ...
        if ($(window).width() > app.settings.screen_md) {
            if (g >= h ? (0 === h && a > g + b ? e.height(a - b) : a >= g + b && (e.height(a - b), g = e.height()), d.height(g)) : (a >= g + b && e.height(a - b), a >= h + b && d.height(a - b)), d.each(function () {
    ...
    block: {
        "delete": function (a, b) {
            ...
            start: function (a) {
                return $(a).append('<div class="block-loading-layer"><div class="app-spinner loading loading-primary"></div></div>'), !0
            }, finish: function (a) {
                return $(a).find(".block-loading-layer").remove(), !0
            }
        }
    },
    panel: {
    ...
    features: {
        gallery: {
            init: function () {
                this.controlHeight(), $(".app-feature-gallery").on("click", "> li:first", function () {
    ...
    contentTabs: function () {
        $(".app-content-tabs").length > 0 && ($(".app-content-tabs a .close-tab").on("click", function (a) {
            ...
            $($(this).parent("a").attr("href")).remove(), $(this).parents("li").remove(), b.find("li:first > a").trigger("click")
